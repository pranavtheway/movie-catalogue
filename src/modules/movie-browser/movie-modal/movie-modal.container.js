...
class MovieModalContainer extends Component {
  ...
  render() {
    ...
    if(this.props.movie !== null){
         movie = movieHelpers.updateMoviePictureUrls(this.props.movie);
         genres = (movie && movie.genres) ? movie.genres.map(genre => genre.name).join(', ') : '';
    }  
